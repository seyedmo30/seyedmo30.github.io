...
مثل ساب ماژول هست  ، من استفاده کردم و توی یه دایرکتوری ، ازش استفاده کردم ، مشکلش اینه که کمی سخته باهاش کار کردن ، همچنین باید یه ریموت جدید بسازیم و برای پول و پوش کردنش باید دستورات اضافی استفاده کنیم
