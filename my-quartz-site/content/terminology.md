...
#### تفاوت boilerplate , template

توی تمپلیت ما می تونیم یه قالب بگیرم و اون را با لاجیک خودمون جابجا کنیم مثل قالب گولنگی که خودم توسعه دادم اما بویلرپلت مثل protoc oapi , swag  و هر چی که خودش کد جنرت میکنه هست
