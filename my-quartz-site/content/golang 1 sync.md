...
اینو به اشتباه نباید هر جا که نیاز به **event passing** داریم ، استفاده کنیم ، بهترین استفاده ی این زمانیه که چندین گوروتین منتظرن و بایه سیگنال ، همه یه کاری رو شروع می کنیم ، بعضی وقتا بهتره از **Event Bus** استفاده کنیم
