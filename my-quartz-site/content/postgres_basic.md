...
توجه شود nvarchar برای پستگرس نیست

همچنین میشه از text به جای varchar  استفاده کرد ، در سرعت و حافظه هیچ تفاوتی ندارد تنها مزییتی که دارد اینه که در آینده نیاز نیست طول رو کوتاه و بزرگ کرد همچنین سادست

تنها در صورتی توجیح دارد که بخواهیم طول را محدود کنیم
